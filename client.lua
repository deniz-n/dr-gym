...
function kolcalis()
  ...
  TriggerEvent("mythic_progbar:client:progress", { name = "kol_calis", duration = Config.kolcalismazamani * 1000, label = 'Kol Kası Çalışıyorsun..', useWhileDead = false, canCancel = true, controlDisables = { disableMovement = true, disableCarMovement = true, disableMouse = false, disableCombat = true,}, animation = { animDict = "", anim = "", }, prop = {model = ""}})
...
function barfikscalis()
  ...
  FreezeEntityPosition(playerPed, true)
  TriggerEvent("mythic_progbar:client:progress", { name = "barfiks_cek", duration = Config.barfikscalismasuresi * 1000, label = 'Barfiks Çekiyorsun..', useWhileDead = false, canCancel = true, controlDisables = { disableMovement = true, disableCarMovement = true, disableMouse = false, disableCombat = true,}, animation = { animDict = "", anim = "", }, prop = {model = ""}})
...
function yogayap()
  ...
  FreezeEntityPosition(playerPed, true)
  TriggerEvent("mythic_progbar:client:progress", { name = "yoga_c", duration = Config.yogasuresi * 1000, label = 'Yoga Yapıyorsun..', useWhileDead = false, canCancel = true, controlDisables = { disableMovement = true, disableCarMovement = true, disableMouse = false, disableCombat = true,}, animation = { animDict = "", anim = "", }, prop = {model = ""}})
...
function mekikcek()
  ...
  onspor = true
  FreezeEntityPosition(playerPed, true)
  TriggerEvent("mythic_progbar:client:progress", { name = "mekik_cek", duration = Config.yogasuresi * 1000, label = 'Mekik Çekiyorsun..', useWhileDead = false, canCancel = true, controlDisables = { disableMovement = true, disableCarMovement = true, disableMouse = false, disableCombat = true,}, animation = { animDict = "", anim = "", }, prop = {model = ""}})
...
function sinavcek()
  ...
  FreezeEntityPosition(playerPed, true)
  TriggerEvent("mythic_progbar:client:progress", { name = "sinav_cek", duration = Config.yogasuresi * 1000, label = 'Şınav Çekiyorsun..', useWhileDead = false, canCancel = true, controlDisables = { disableMovement = true, disableCarMovement = true, disableMouse = false, disableCombat = true,}, animation = { animDict = "", anim = "", }, prop = {model = ""}})
...
function sual()
  ...
  SetEntityHeading(playerPed, Config.Coords.SuAl.h)
	...
	TriggerEvent("mythic_progbar:client:progress", { name = "su_al", duration = Config.sualmazamani * 1000, label = 'Su Alıyorsun..', useWhileDead = false, canCancel = true, controlDisables = { disableMovement = true, disableCarMovement = true, disableMouse = false, disableCombat = true,}, animation = { animDict = "", anim = "", }, prop = {model = ""}})
